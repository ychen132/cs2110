...
class A2Test {
    ...
    void testsixth() {
        ...
        assertEquals(1, A2.nCat("fk this shit I am out", "fk this shit I am out"));
    ...
    void testSeventh() {
        ...
        assertEquals(1, A2.shortest("xxxxxxxxxx"));
        assertEquals(2, A2.shortest("xyxyxyxyxyxy"));
        assertEquals(3, A2.shortest("syzsyzsyzsyz"));
        assertEquals(5, A2.shortest("hellohellohello"));
        assertEquals(11, A2.shortest("hellohelloh"));
